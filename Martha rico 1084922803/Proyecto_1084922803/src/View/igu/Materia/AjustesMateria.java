 ...
 * @author Stork
 */
public class AjustesMateria extends javax.swing.JFrame {

    /**
     * Creates new form AjustesContinente
     */
    public AjustesMateria() {
        initComponents();
    ...
    private void btnModificarEstuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarEstuActionPerformed
        ModificarMateria mod = new ModificarMateria();
        mod.setVisible(true);
        this.dispose();
    ...
    private void btnEliminarEstuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarEstuActionPerformed
        EliminarMateria delete = new EliminarMateria();
