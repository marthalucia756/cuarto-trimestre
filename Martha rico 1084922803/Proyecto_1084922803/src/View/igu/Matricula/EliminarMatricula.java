...
public class EliminarMatricula extends javax.swing.JFrame {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        EliminarMatricula eliminar = new EliminarMatricula();
    ...
    public void mostrar() {
        ...
        try {
            ...
            while (rs.next()) {                
                ...
                estado[3] = rs.getInt("nota2");
                estado[3] = rs.getInt("nota3");
                estado[4] = rs.getInt("promedio");
                estado[5] = rs.getInt("id_estudiante");
